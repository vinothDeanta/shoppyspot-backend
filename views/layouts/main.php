...
echo"testing for renderinng".Yii::$app->request->baseUrl;
?>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper"> 
          <div>
            <div class="logo-wrapper"><a href="index.html"><img class="img-fluid for-light" src="<?= Yii::getAlias('@web') ?>/images/logo/small-logo.png" alt=""><img class="img-fluid for-dark" src="<?= Yii::getAlias('@web') ?>/images/logo/small-white-logo.png" alt=""></a>
            ...
            <nav class="sidebar-main">
              ...
              <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                  <li class="back-btn"><a href="index.html"><img class="img-fluid" src="<?= Yii::getAlias('@web') ?>/images/logo-icon.png" alt=""></a>
                ...
                <div class="sidebar-img-section">
                  <div class="sidebar-img-content"><img class="img-fluid" src="<?= Yii::getAlias('@web') ?>/images/side-bar.png" alt="">
            ...
            <div class="row">
                    ...
                    <div class="table-responsive">        
                      <table class="table table-bordernone">                          
                        <tbody> 
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/rectangle-26.png" alt="">
                          ...
                          <tr>
                            <td>
                              <div class="media"> <img class="img-fluid me-3 b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/rectangle-27.png" alt="">
                                <div class="media-body"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/rectangle-28.png" alt="">
                                <div class="media-body"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="media"><img class="img-fluid me-3 b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/rectangle-29.png" alt="">
                                <div class="media-body"><a href="product-page.html">
                      ...
                      <table class="table table-bordernone">
                        ...
                        <tbody> 
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/running-shoe.png" alt=""></div>
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/hand-bag.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/sun-glasses.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page.html">
                          ...
                          <tr>
                            <td>
                              <div class="media">
                                <div class="square-box me-2"><img class="img-fluid b-r-5" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/shirt.png" alt=""></div>
                                <div class="media-body ps-2">
                                  <div class="avatar-details"><a href="product-page.html">
                      ...
                      <div class="item">
                        <div class="row discount-block"> 
                          ...
                          <div class="col-xl-5 col-lg-12 dash-xl-100">
                            <div class="img-wrraper"><img class="img-fluid" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/image.png" alt=""></div>
                          </div>
                        </div>
                      </div>
                      <div class="item">
              ...
              <div class="col-xl-4 col-md-6 dash-xl-50 dash-29">
                <div class="card bg-primary get-support">
                  <div class="card-body">
                    <div class="support-sec-img"><img class="img-fluid" src="<?= Yii::getAlias('@web') ?>/images/dashboard-2/support-img.png" alt=""></div>
